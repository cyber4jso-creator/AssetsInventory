    ...
    <header className="h-14 bg-white flex items-center gap-4 px-5 flex-shrink-0 print:hidden"
      ...
      <div className="flex items-center gap-2 mr-auto">
        <div className="relative hidden md:block w-52">
          <Search size={13} className="absolute top-1/2 -translate-y-1/2 right-3 text-[#6B7280]" />
        ...
        <div className="flex items-center gap-2 cursor-pointer group">
          ...
          <span className="text-sm font-medium text-[#2B2B2B] hidden lg:block">{firstName}</span>
        </div>
      </div>
    </header>
  );
